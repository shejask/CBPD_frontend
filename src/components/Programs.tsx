            ...
            <TiltCard key={index} sensitivity={8} className="relative z-10">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  {item.img && <img src={item.img} alt={item.name} width={64} height={64} className="w-16 h-16 shrink-0 rounded-lg object-cover group-hover:scale-105 transition-transform" />}
