...
const programs = [
  { 
    title: "CBPD Certificate in Beauty Therapy", 
    desc: "Master core beauty treatments including facials, waxing, manicure, pedicure, and skin care fundamentals." 
  },
  { 
    title: "CBPD Certificate in Advanced Beauty Therapy & Aesthetics", 
    desc: "Develop advanced skills in electrical treatments, microdermabrasion, chemical peels, and non-invasive aesthetic procedures." 
  },
  { 
    title: "CBPD Certificate in Makeup Artistry & Special Effects", 
    desc: "Learn professional makeup application, bridal makeup, fashion makeup, and special effects techniques." 
  },
  { 
    title: "CBPD Certificate in Hairdressing & Barbering Techniques", 
    desc: "Gain practical skills in cutting, styling, colouring, and modern hairdressing practices." 
  },
  { 
    title: "CBPD Certificate in Spa & Wellness Therapy", 
    desc: "Focus on spa treatments, body therapies, aromatherapy, Indian head massage, and holistic wellness services." 
  },
  { 
    title: "CBPD Certificate in Massage Therapy", 
    desc: "Master Swedish massage, deep tissue massage, sports massage, and therapeutic massage techniques." 
  },
  { 
    title: "CBPD Certificate in Nail Technology & Enhancements", 
    desc: "Specialised training in manicure, pedicure, gel nails, acrylic nails, and nail art." 
  },
  { 
    title: "CBPD Certificate in Skincare & Facial Treatments", 
    desc: "Learn advanced skincare analysis, facial therapies, anti-ageing treatments, and product knowledge." 
  },
  { 
    title: "CBPD Certificate in Salon & Spa Management", 
    desc: "Develop business skills for running successful salons and spas, including operations, marketing, and team leadership." 
  },
  { 
    title: "CBPD Certificate in Holistic Wellness & Ayurveda", 
    desc: "Explore holistic approaches, Ayurvedic principles, wellness coaching, and mind-body balance techniques." 
  },
  { 
    title: "CBPD Certificate in Reflexology & Aromatherapy", 
    desc: "Gain expertise in reflexology, essential oil applications, and complementary wellness therapies." 
  },
  { 
    title: "CBPD Certificate in Lash & Brow Treatments", 
    desc: "Specialised training in eyelash extensions, brow shaping, tinting, and lamination techniques." 
  },
  { 
    title: "CBPD Certificate in Health & Safety in Beauty & Wellness", 
    desc: "Focus on hygiene standards, infection control, COSHH, and safe working practices in beauty environments." 
  },
  { 
    title: "CBPD Certificate in Client Consultation & Customer Care", 
    desc: "Master professional consultation techniques, skin/hair analysis, and exceptional client experience management." 
  },
  { 
    title: "CBPD Certificate in Advanced Beauty & Wellness Business Management", 
    desc: "For experienced professionals — strategic salon/spa business planning, branding, and growth strategies." 
  }
];

const benefits = [
  "Practical, hands-on learning with immediate application in salons, spas, and wellness centres",
  "Flexible delivery modes designed for working beauty and wellness professionals",
  "Prestigious UK-issued CBPD certification recognised by employers in the beauty and wellness industry",
  "Strong coverage of both traditional beauty treatments and modern wellness practices",
  "Clear pathways for career progression from therapist roles to salon/spa management and specialist positions"
];

const steps = [
  "Select the CBPD Beauty & Wellness programme that matches your role and career goals",
...
export default function BeautyWellnessProgramPage() {
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-primary-900 pb-20">
      ...
      <div className="bg-white dark:bg-primary-900 pt-32 pb-4 border-b border-slate-200 dark:border-primary-800">
        <div className="container mx-auto px-6 md:px-12 flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400 font-medium">
          ...
          <span className="text-slate-300 dark:text-slate-600">/</span>
          <span className="text-slate-900 dark:text-white">Beauty & Wellness Programmes</span>
        </div>
      </div>
      ...
      <section className="py-20 lg:py-24 relative overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('/images/external/1560066984-138dadb4c035.jpg')` }}
        ></div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-8">
              CBPD <span className="text-brand-red">Beauty & Wellness Programmes</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed font-light">
              Equipping beauty therapists, spa professionals, wellness practitioners, salon managers, makeup artists, and aesthetic specialists with immediately applicable skills for the fast-growing beauty and wellness industry.
            </p>
      ...
      <section className="bg-brand-red/5 dark:bg-brand-red/10 border-b border-slate-200 dark:border-primary-800 py-10">
        <div className="container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <p className="text-lg md:text-xl text-slate-700 dark:text-slate-200 font-medium leading-relaxed">
            The Central Board of Professional Development (CBPD) offers a comprehensive range of practical Beauty & Wellness programmes designed to equip professionals with immediately applicable skills for the fast-growing beauty and wellness industry.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
            ...
            <div className="lg:w-[65%] xl:w-[70%]">
              ...
              <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 mb-12">
                <p>
                  CBPD Beauty & Wellness certifications focus on <strong>professional treatment techniques, client care, salon/spa operations, hygiene standards, and modern wellness practices</strong> — helping professionals deliver exceptional services while enabling salons, spas, clinics, and wellness centres to maintain high standards of quality, safety, and customer satisfaction.
                </p>
                <p>
                  All CBPD Beauty & Wellness programmes are delivered flexibly through our authorised partners in online, blended, or classroom formats and lead to prestigious UK-issued CBPD certifications recognised by employers in the UK and internationally.
                </p>
              </div>
              ...
              {activeTab === 'overview' && (
                <div className="animate-[fadeInUp_0.5s_ease-out]">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-8">
                    CBPD provides targeted, high-impact programmes across key beauty, aesthetic, and wellness disciplines.
                  </p>
              ...
              {activeTab === 'why' && (
                <div className="animate-[fadeInUp_0.5s_ease-out] bg-white dark:bg-primary-800 p-8 rounded border border-slate-200 dark:border-primary-700 shadow-sm">
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Why Choose CBPD for Beauty & Wellness Professional Development?</h2>
                  <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    CBPD delivers shorter, more practical, and flexible beauty & wellness credentials compared with many traditional qualifications. 
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                    Our programmes combine technical treatment skills with essential business and client care knowledge — helping professionals and businesses thrive in the growing global beauty and wellness industry.
                  </p>
                </div>
              )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-primary-900 p-10 lg:p-12 rounded-sm relative overflow-hidden flex flex-col justify-center items-start group">
            ...
            <p className="text-slate-300 mb-8 max-w-sm relative z-10">
              Authorised partners have exclusive rights to deliver CBPD beauty & wellness programmes globally.
            </p>
