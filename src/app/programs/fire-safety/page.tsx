...
const programs = [
  { 
    title: "CBPD Certificate in Fire Safety Management", 
    desc: "Develop comprehensive skills in fire risk assessment, fire safety management systems, policy development, and ongoing compliance in commercial, industrial, and residential buildings." 
  },
  { 
    title: "CBPD Certificate in Fire Risk Assessment", 
    desc: "Master the principles and methodology of conducting thorough fire risk assessments, identifying hazards, evaluating risks, and implementing effective control measures." 
  },
  { 
    title: "CBPD Certificate in Fire Prevention & Protection Systems", 
    desc: "Gain practical knowledge of active and passive fire protection systems, including detection, alarm, suppression, sprinkler systems, and compartmentation." 
  },
  { 
    title: "CBPD Certificate in Fire Safety Engineering", 
    desc: "Learn the fundamentals of fire dynamics, smoke control, structural fire protection, evacuation modelling, and performance-based fire engineering design." 
  },
  { 
    title: "CBPD Certificate in Emergency Planning & Response", 
    desc: "Build expertise in developing emergency response plans, crisis management, evacuation procedures, and coordination with emergency services." 
  },
  { 
    title: "CBPD Certificate in Fire Warden & Marshal Training", 
    desc: "Practical training for fire wardens and marshals covering duties, incident command, evacuation management, and post-incident reporting." 
  },
  { 
    title: "CBPD Certificate in Fire Safety in Construction", 
    desc: "Focus on fire safety during construction and refurbishment projects, including hot work permits, temporary fire precautions, and compliance with CDM regulations." 
  },
  { 
    title: "CBPD Certificate in Fire Safety in Healthcare & Care Settings", 
    desc: "Specialised training on fire safety challenges in hospitals, nursing homes, and care facilities, including patient evacuation and compartmentation." 
  },
  { 
    title: "CBPD Certificate in Hazardous Materials & Chemical Fire Safety", 
    desc: "Understand risks associated with flammable liquids, gases, and hazardous substances, along with appropriate storage, handling, and firefighting techniques." 
  },
  { 
    title: "CBPD Certificate in Fire Investigation & Root Cause Analysis", 
    desc: "Learn systematic approaches to fire scene investigation, evidence collection, and determining root causes of fire incidents." 
  },
  { 
    title: "CBPD Certificate in Regulatory Compliance & Fire Legislation", 
    desc: "Cover key UK fire safety legislation, including the Regulatory Reform (Fire Safety) Order 2005, Building Regulations, and international standards." 
  },
  { 
    title: "CBPD Certificate in Fire Safety Auditing & Inspection", 
    desc: "Develop skills to conduct effective fire safety audits, inspections, gap analysis, and continual improvement programmes." 
  },
  { 
    title: "CBPD Certificate in Workplace Fire Safety & Training", 
    desc: "Design and deliver effective fire safety awareness training for employees across all types of workplaces." 
  },
  { 
    title: "CBPD Certificate in Advanced Fire Safety Management", 
    desc: "For experienced professionals — advanced techniques in strategic fire safety planning, performance-based design, and organisational resilience." 
  },
  { 
    title: "CBPD Certificate in Integrated Fire & Security Systems", 
    desc: "Explore the integration of fire detection, alarm, suppression, and security systems for modern intelligent buildings." 
  }
];

const benefits = [
  "Practical, compliance-focused learning with immediate application in real environments.",
  "Flexible delivery modes designed for working fire safety and facilities professionals.",
  "Prestigious UK-issued CBPD certification recognised by employers in the UK and globally.",
  "Strong alignment with current UK fire safety legislation and international best practices.",
  "Clear pathways for career progression in fire safety management, engineering, and compliance roles."
];

const steps = [
  "Select the CBPD Fire & Safety programme that matches your role and responsibilities.",
...
export default function FireSafetyProgramPage() {
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-primary-900 pb-20">
      ...
      <div className="bg-white dark:bg-primary-900 pt-32 pb-4 border-b border-slate-200 dark:border-primary-800">
        <div className="container mx-auto px-6 md:px-12 flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400 font-medium">
          ...
          <span className="text-slate-300 dark:text-slate-600">/</span>
          <span className="text-slate-900 dark:text-white">Fire & Safety Programmes</span>
        </div>
      </div>
      ...
      <section className="py-20 lg:py-24 relative overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1599708709322-8356f9175084?q=80&w=1600&auto=format&fit=crop')` }}
        ></div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-8">
              CBPD <span className="text-brand-red">Fire & Safety</span> Programmes
            </h1>
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed font-light">
              Equipping fire safety officers, engineers, building managers, site supervisors, and compliance professionals with immediately applicable skills for stringent risk management.
            </p>
      ...
      <section className="bg-brand-blue/5 dark:bg-brand-blue/10 border-b border-slate-200 dark:border-primary-800 py-10">
        <div className="container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <p className="text-lg md:text-xl text-slate-700 dark:text-slate-200 font-medium leading-relaxed">
            The Central Board of Professional Development (CBPD) offers a comprehensive range of practical Fire & Safety programmes designed to help professionals protect lives and property while enabling organisations to meet UK and international standards.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
            ...
            <div className="lg:w-[65%] xl:w-[70%]">
              ...
              <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 mb-12">
                <p>
                  CBPD Fire & Safety certifications focus on <strong>real-world fire prevention, risk assessment, regulatory compliance, emergency planning, and life safety systems</strong>. 
                </p>
                <p>
                  These certifications empower professionals to establish robust preventative measures, ensuring teams can operate with confidence across commercial, industrial, and residential sectors. All CBPD Fire & Safety programmes are delivered flexibly through our authorised partners in online, blended, or classroom formats and lead to prestigious UK-issued CBPD certifications globally recognised by employers.
                </p>
              </div>
              ...
              {activeTab === 'overview' && (
                <div className="animate-[fadeInUp_0.5s_ease-out]">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-8">
                    CBPD provides targeted, high-impact programmes across key fire safety and protection disciplines to build resilience and competence.
                  </p>
              ...
              {activeTab === 'why' && (
                <div className="animate-[fadeInUp_0.5s_ease-out] bg-white dark:bg-primary-800 p-8 rounded border border-slate-200 dark:border-primary-700 shadow-sm">
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Why Choose CBPD for Fire & Safety Professional Development?</h2>
                  <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    CBPD delivers shorter, more practical, and highly flexible fire & safety credentials compared with many traditional safety qualifications. 
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                    Our programmes combine rigorous safety standards with real-world application, helping professionals and organisations achieve higher levels of compliance, risk reduction, and overarching life safety protection.
                  </p>
                </div>
              )}
            ...
            <div className="lg:w-[35%] xl:w-[30%]">
              <div className="sticky top-28 space-y-6">
                ...
                <div className="bg-primary-900 rounded-sm shadow-lg p-6 lg:p-8 text-center text-white relative overflow-hidden">
                   ...
                   <p className="text-sm text-slate-300 mb-6 relative z-10">Our support team is ready to help you find the right fire & safety programme.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-primary-900 p-10 lg:p-12 rounded-sm relative overflow-hidden flex flex-col justify-center items-start group">
            ...
            <p className="text-slate-300 mb-8 max-w-sm relative z-10">
              Authorised partners have exclusive rights to deliver CBPD fire & safety programmes globally.
            </p>
