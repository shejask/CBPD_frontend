...
const programs = [
  { 
    title: "CBPD Certificate in Data Science", 
    desc: "Master data analysis, statistical modelling, machine learning fundamentals, data visualisation, and extracting actionable insights from complex datasets." 
  },
  { 
    title: "CBPD Certificate in Artificial Intelligence", 
    desc: "Gain practical knowledge of AI concepts, machine learning algorithms, neural networks, natural language processing, and ethical AI implementation." 
  },
  { 
    title: "CBPD Certificate in Cyber Security", 
    desc: "Develop essential skills in threat detection, network security, ethical hacking, risk assessment, data protection, and compliance with security standards." 
  },
  { 
    title: "CBPD Certificate in Digital Marketing", 
    desc: "Learn modern digital marketing strategies, SEO, social media marketing, content marketing, analytics, and campaign management for business growth." 
  },
  { 
    title: "CBPD Certificate in Information Technology & Services", 
    desc: "Build foundational and advanced IT service management skills, including ITIL principles, service desk operations, and IT infrastructure support." 
  },
  { 
    title: "CBPD Certificate in Software Development", 
    desc: "Practical training in programming languages, software engineering principles, agile development, testing, and full software development lifecycle." 
  },
  { 
    title: "CBPD Certificate in Web and App Development", 
    desc: "Master front-end and back-end technologies for building responsive websites and mobile applications using current frameworks and tools." 
  },
  { 
    title: "CBPD Certificate in Web Design", 
    desc: "Develop creative and technical skills in UI/UX design, responsive web design, HTML/CSS, and user-centred interface development." 
  },
  { 
    title: "CBPD Certificate in Cloud Computing & Infrastructure", 
    desc: "Explore cloud platforms, virtualisation, cloud architecture, deployment strategies, and secure cloud management." 
  },
  { 
    title: "CBPD Certificate in Database Management & Big Data", 
    desc: "Learn relational and non-relational databases, SQL/NoSQL, data warehousing, and handling large-scale data environments." 
  },
  { 
    title: "CBPD Certificate in IT Project Management", 
    desc: "Apply project management methodologies tailored to technology projects, including agile, scrum, and risk management in IT." 
  },
  { 
    title: "CBPD Certificate in Networking & Systems Administration", 
    desc: "Gain expertise in network configuration, server administration, troubleshooting, and maintaining robust IT systems." 
  },
  { 
    title: "CBPD Certificate in Digital Transformation & Business Technology", 
    desc: "Understand how technology drives business change, automation, innovation, and digital strategy implementation." 
  },
  { 
    title: "CBPD Certificate in Ethical Hacking & Penetration Testing", 
    desc: "Learn offensive security techniques, vulnerability assessment, and methods to strengthen organisational cyber defences." 
  },
  { 
    title: "CBPD Certificate in IT Leadership & Digital Strategy", 
    desc: "Develop leadership skills for IT professionals, including strategic planning, team management, and aligning technology with business goals." 
  }
];

const benefits = [
  "Practical, job-focused learning with immediate application in real technology environments.",
  "Flexible delivery modes designed for busy IT professionals and career changers.",
  "Prestigious UK-issued CBPD certification recognised by employers in the UK and globally.",
  "Strong coverage of high-demand areas including Data Science, Artificial Intelligence, Cyber Security, Digital Marketing, Software Development, and Web & App Development.",
  "Clear pathways for career progression in technical, analytical, and leadership IT roles."
];

const steps = [
  "Select the CBPD Information Technology programme that matches your role and career goals.",
...
export default function InformationTechnologyProgramPage() {
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-primary-900 pb-20">
      ...
      <div className="bg-white dark:bg-primary-900 pt-32 pb-4 border-b border-slate-200 dark:border-primary-800">
        <div className="container mx-auto px-6 md:px-12 flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400 font-medium">
          ...
          <span className="text-slate-300 dark:text-slate-600">/</span>
          <span className="text-slate-900 dark:text-white">Information Technology Programmes</span>
        </div>
      </div>
      ...
      <section className="py-20 lg:py-24 relative overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('/images/external/1550751827-4bd374c3f58b.jpg')` }}
        ></div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-8">
              CBPD <span className="text-brand-red">Information Technology</span> Programmes
            </h1>
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed font-light">
              Equipping IT professionals, developers, analysts, cybersecurity specialists, and digital transformation leaders with immediately applicable skills for today's fast-evolving technology landscape.
            </p>
      ...
      <section className="bg-brand-blue/5 dark:bg-brand-blue/10 border-b border-slate-200 dark:border-primary-800 py-10">
        <div className="container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <p className="text-lg md:text-xl text-slate-700 dark:text-slate-200 font-medium leading-relaxed">
            The Central Board of Professional Development (CBPD) offers a comprehensive range of practical Information Technology programmes designed to equip professionals with directly applicable skills for real-world digital environments.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
            ...
            <div className="lg:w-[65%] xl:w-[70%]">
              ...
              <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 mb-12">
                <p>
                  CBPD Information Technology certifications focus on <strong>real-world application, emerging technologies, system security, data-driven decision making, and digital innovation</strong>. 
                </p>
                <p>
                  This focus helps professionals stay competitive while enabling organisations to enhance efficiency, security, and digital capabilities. All CBPD Information Technology programmes are delivered flexibly through our authorised partners in online, blended, or classroom formats and lead to prestigious UK-issued CBPD certifications.
                </p>
              </div>
              ...
              {activeTab === 'overview' && (
                <div className="animate-[fadeInUp_0.5s_ease-out]">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-8">
                    CBPD provides targeted, high-impact programmes across key IT and digital disciplines, including the latest in data and intelligent technologies.
                  </p>
              ...
              {activeTab === 'why' && (
                <div className="animate-[fadeInUp_0.5s_ease-out] bg-white dark:bg-primary-800 p-8 rounded border border-slate-200 dark:border-primary-700 shadow-sm">
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Why Choose CBPD for Information Technology Professional Development?</h2>
                  <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    CBPD delivers shorter, more practical, and highly flexible IT credentials when compared with many traditional qualifications. 
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                    Our targeted programmes seamlessly combine core technology skills with cutting-edge topics such as Data Science, Artificial Intelligence, and Cyber Security—helping professionals and organisations thrive in the rapidly changing digital world.
                  </p>
                </div>
              )}
            ...
            <div className="lg:w-[35%] xl:w-[30%]">
              <div className="sticky top-28 space-y-6">
                ...
                <div className="bg-primary-900 rounded-sm shadow-lg p-6 lg:p-8 text-center text-white relative overflow-hidden">
                   ...
                   <p className="text-sm text-slate-300 mb-6 relative z-10">Our support team is ready to help you find the right technology programme.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-primary-900 p-10 lg:p-12 rounded-sm relative overflow-hidden flex flex-col justify-center items-start group">
            ...
            <p className="text-slate-300 mb-8 max-w-sm relative z-10">
              Authorised partners have exclusive rights to deliver CBPD IT programmes globally.
            </p>
