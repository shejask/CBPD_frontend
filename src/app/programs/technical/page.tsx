...
const programs = [
  { 
    ...
    desc: "Comprehensive training in mobile phone repair, diagnostics, screen replacement, software flashing, hardware troubleshooting, and customer service for smartphone repair professionals." 
  },
  { 
    title: "CBPD Diploma in AC/Fridge Technician", 
    desc: "Practical skills in installation, repair, and maintenance of air conditioners, refrigerators, and cooling systems, including fault finding, gas charging, electrical components, and safety procedures." 
  },
  { 
    title: "CBPD Certificate in Electrical Technician", 
    desc: "Master domestic and commercial electrical installations, fault finding, wiring, testing, and compliance with safety regulations." 
  },
  { 
    title: "CBPD Certificate in Plumbing & Heating Technician", 
    desc: "Develop skills in plumbing systems, central heating, boiler maintenance, pipework, and water supply installations." 
  },
  { 
    title: "CBPD Certificate in Automotive Technician", 
    desc: "Learn vehicle diagnostics, engine repair, electrical systems, brakes, and general automotive maintenance." 
  },
  { 
    title: "CBPD Certificate in Computer Hardware & Networking Technician", 
    desc: "Gain expertise in PC repair, hardware assembly, troubleshooting, and basic networking support." 
  },
  { 
    title: "CBPD Certificate in Refrigeration & Air Conditioning Technician", 
    desc: "Specialised training in commercial refrigeration, AC systems, installation, servicing, and energy efficiency." 
  },
  { 
    title: "CBPD Certificate in Home Appliance Repair Technician", 
    desc: "Focus on repairing washing machines, ovens, cookers, and other household appliances." 
  },
  { 
    title: "CBPD Certificate in CCTV & Security Systems Installation", 
    desc: "Learn installation, configuration, and maintenance of CCTV cameras, access control, and security systems." 
  },
  { 
    title: "CBPD Certificate in Solar PV Installation & Maintenance", 
    desc: "Practical skills in solar panel installation, inverter setup, system maintenance, and safety standards." 
  },
  { 
    title: "CBPD Certificate in Generator & Power Systems Technician", 
    desc: "Training in diesel generator installation, maintenance, troubleshooting, and backup power systems." 
  },
  { 
    title: "CBPD Certificate in Technical Customer Service & Support", 
    desc: "Develop skills in handling technical enquiries, problem-solving, and delivering excellent customer support." 
  },
  { 
    title: "CBPD Certificate in Workshop Safety & Risk Management", 
    desc: "Focus on health & safety in technical workshops, risk assessment, PPE, and safe working practices." 
  },
  { 
    title: "CBPD Certificate in Diagnostic Tools & Modern Technology", 
    desc: "Learn to use advanced diagnostic equipment, software tools, and modern technical troubleshooting methods." 
  },
  { 
    title: "CBPD Certificate in Advanced Technical Management", 
    desc: "For experienced technicians — workshop management, team leadership, business operations, and quality control." 
  }
];
...
const benefits = [
  ...
  "Strong coverage of high-demand areas including Diploma in Mobile Phone Technician and Diploma in AC/Fridge Technician.",
  "Clear pathways for career progression from technician roles to senior technical and management positions."
];

const steps = [
  "Select the CBPD Technical programme that matches your role and career goals.",
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-8">
              CBPD <span className="text-brand-red">Technical</span> Programmes
            </h1>
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed font-light">
              Equipping technicians, service engineers, and maintenance professionals with immediately applicable hands-on skills for modern repair industries.
            </p>
      ...
      <section className="bg-brand-blue/5 dark:bg-brand-blue/10 border-b border-slate-200 dark:border-primary-800 py-10">
        <div className="container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <p className="text-lg md:text-xl text-slate-700 dark:text-slate-200 font-medium leading-relaxed">
            The Central Board of Professional Development (CBPD) offers a comprehensive range of practical Technical programmes designed to help professionals deliver high-quality technical services.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
            ...
            <div className="lg:w-[65%] xl:w-[70%]">
              ...
              <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 mb-12">
                <p>
                  CBPD Technical certifications focus on <strong>fault diagnosis, repair techniques, maintenance procedures, safety standards, and customer service</strong>. 
                </p>
                <p>
                  By mastering these hands-on skills, professionals empower workshops, service centres, and technical businesses to operate efficiently and professionally. All CBPD Technical programmes are delivered flexibly through our authorised partners in online, blended, or classroom formats and lead to prestigious UK-issued CBPD certifications globally recognised by employers.
                </p>
              </div>
              ...
              {activeTab === 'overview' && (
                <div className="animate-[fadeInUp_0.5s_ease-out]">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-8">
                    CBPD provides targeted, high-impact programmes across key technical service and repair disciplines.
                  </p>
              ...
              {activeTab === 'why' && (
                <div className="animate-[fadeInUp_0.5s_ease-out] bg-white dark:bg-primary-800 p-8 rounded border border-slate-200 dark:border-primary-700 shadow-sm">
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Why Choose CBPD for Technical Professional Development?</h2>
                  <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    CBPD delivers shorter, more practical, and flexible technical credentials compared with many traditional qualifications. 
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                    Our programmes combine strong hands-on repair skills with modern diagnostic techniques and safety standards — helping professionals and businesses deliver reliable, high-quality technical services.
                  </p>
                </div>
              )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-primary-900 p-10 lg:p-12 rounded-sm relative overflow-hidden flex flex-col justify-center items-start group">
            ...
            <p className="text-slate-300 mb-8 max-w-sm relative z-10">
              Authorised partners have exclusive rights to deliver CBPD technical programmes globally.
            </p>
