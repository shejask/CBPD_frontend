...
const programs = [
  { 
    title: "CBPD Certificate in Construction Project Management", 
    desc: "Master the full project lifecycle including planning, scheduling, resource management, risk assessment, and successful delivery of construction projects on time and within budget." 
  },
  { 
    title: "CBPD Certificate in Site Management & Supervision", 
    desc: "Develop essential skills in daily site operations, team leadership, subcontractor coordination, progress monitoring, and problem-solving on live construction sites." 
  },
  { 
    title: "CBPD Certificate in Health & Safety in Construction", 
    desc: "Gain in-depth knowledge of construction-specific health and safety regulations, risk assessments, accident prevention, and compliance with UK and international standards." 
  },
  { 
    title: "CBPD Certificate in Sustainable Construction Practices", 
    desc: "Learn modern approaches to green building, energy-efficient design, sustainable materials, waste reduction, and achieving environmental standards such as BREEAM and LEED awareness." 
  },
  { 
    title: "CBPD Certificate in Quantity Surveying & Cost Management", 
    desc: "Build expertise in cost planning, tendering, contract administration, variation management, and financial control of construction projects." 
  },
  { 
    title: "CBPD Certificate in Construction Contract Law & Administration", 
    desc: "Understand key construction contracts, legal obligations, dispute resolution, claims management, and effective contract administration." 
  },
  { 
    title: "CBPD Certificate in Building Information Modelling (BIM) Awareness", 
    desc: "Develop practical knowledge of BIM principles, digital construction processes, collaboration tools, and the benefits of BIM for project efficiency and accuracy." 
  },
  { 
    title: "CBPD Certificate in Construction Quality Management", 
    desc: "Implement effective quality assurance systems, inspection procedures, defect management, and continuous improvement on construction projects." 
  },
  { 
    title: "CBPD Certificate in Civil Engineering Site Practices", 
    desc: "Focus on groundworks, foundations, structural works, drainage, and infrastructure delivery with strong emphasis on safety and best practice." 
  },
  { 
    title: "CBPD Certificate in Risk Management in Construction", 
    desc: "Identify, assess, and mitigate project risks including financial, operational, health & safety, and supply chain risks throughout the project lifecycle." 
  },
  { 
    title: "CBPD Certificate in Procurement & Supply Chain Management for Construction", 
    desc: "Learn strategic sourcing, supplier selection, material management, and supply chain optimisation to reduce costs and improve project delivery." 
  },
  { 
    title: "CBPD Certificate in Construction Leadership & Team Management", 
    desc: "Enhance leadership skills specifically tailored for construction environments, including motivating diverse teams and managing performance under pressure." 
  },
  { 
    title: "CBPD Certificate in Renovation, Refurbishment & Retrofit Management", 
    desc: "Develop specialist skills in managing building refurbishment, retrofitting, heritage projects, and modernisation works." 
  },
  { 
    title: "CBPD Certificate in Construction Health & Safety Management (Advanced)", 
    desc: "For experienced professionals — advanced techniques in safety leadership, CDM regulations, audit processes, and developing robust safety cultures." 
  },
  { 
    title: "CBPD Certificate in Digital Construction & Emerging Technologies", 
    desc: "Explore the impact of drones, AI, modular construction, and smart technologies on modern construction practices and project delivery." 
  }
];

const benefits = [
  "Practical, site-focused learning with immediate application on real projects.",
  "Flexible delivery modes designed for working construction professionals.",
  "Prestigious UK-issued CBPD certification recognised by employers in the UK and globally.",
  "Strong alignment with current UK construction standards and international best practices.",
  "Clear pathways for career progression in site supervision, project management, and specialist roles."
];

const steps = [
  "Select the CBPD Construction programme that matches your role and goals.",
...
export default function ConstructionProgramPage() {
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-primary-900 pb-20">
      ...
      <div className="bg-white dark:bg-primary-900 pt-32 pb-4 border-b border-slate-200 dark:border-primary-800">
        <div className="container mx-auto px-6 md:px-12 flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400 font-medium">
          ...
          <span className="text-slate-300 dark:text-slate-600">/</span>
          <span className="text-slate-900 dark:text-white">Construction Programmes</span>
        </div>
      </div>
      ...
      <section className="py-20 lg:py-24 relative overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1541888081621-fc327581bf83?q=80&w=1600&auto=format&fit=crop')` }}
        ></div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-8">
              CBPD <span className="text-brand-red">Construction</span> Programmes
            </h1>
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed font-light">
              Equipping site managers, supervisors, engineers, and construction professionals with immediately applicable on-site skills.
            </p>
      ...
      <section className="bg-brand-blue/5 dark:bg-brand-blue/10 border-b border-slate-200 dark:border-primary-800 py-10">
        <div className="container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <p className="text-lg md:text-xl text-slate-700 dark:text-slate-200 font-medium leading-relaxed">
            The Central Board of Professional Development (CBPD) offers a comprehensive range of practical Construction programmes designed to help professionals advance their careers in today's demanding built environment.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
            ...
            <div className="lg:w-[65%] xl:w-[70%]">
              ...
              <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 mb-12">
                <p>
                  CBPD Construction certifications focus on <strong>real-world project delivery, health & safety compliance, sustainable practices, cost control, and regulatory standards</strong>. 
                </p>
                <p>
                  These credentials empower professionals to meet high standards and enabling companies to deliver safer, higher-quality, and more efficient projects. All CBPD Construction programmes are delivered flexibly through our authorised partners in online, blended, or classroom formats and lead to prestigious UK-issued CBPD certifications globally recognised by employers.
                </p>
              </div>
              ...
              {activeTab === 'overview' && (
                <div className="animate-[fadeInUp_0.5s_ease-out]">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-8">
                    CBPD provides targeted, high-impact programmes across key construction disciplines. Each programme emphasises practical application, current industry standards, and measurable on-site results.
                  </p>
              ...
              {activeTab === 'why' && (
                <div className="animate-[fadeInUp_0.5s_ease-out] bg-white dark:bg-primary-800 p-8 rounded border border-slate-200 dark:border-primary-700 shadow-sm">
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Why Choose CBPD for Construction Professional Development?</h2>
                  <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    CBPD delivers shorter, more practical, and highly flexible construction credentials compared with many traditional qualifications. 
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                    Our programmes combine rigorous UK professional standards with modern topics such as sustainability, BIM, and digital construction — helping professionals and companies achieve faster compliance, improved safety, and better project outcomes.
                  </p>
                </div>
              )}
            ...
            <div className="lg:w-[35%] xl:w-[30%]">
              <div className="sticky top-28 space-y-6">
                ...
                <div className="bg-primary-900 rounded-sm shadow-lg p-6 lg:p-8 text-center text-white relative overflow-hidden">
                   ...
                   <p className="text-sm text-slate-300 mb-6 relative z-10">Our support team is ready to help you find the right construction programme.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-primary-900 p-10 lg:p-12 rounded-sm relative overflow-hidden flex flex-col justify-center items-start group">
            ...
            <p className="text-slate-300 mb-8 max-w-sm relative z-10">
              Authorised partners have exclusive rights to deliver CBPD construction programmes globally.
            </p>
