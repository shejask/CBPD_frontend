...
const programs = [
  { 
    title: "CBPD Certificate in Tourism Management", 
    desc: "Develop core skills in tourism business operations, destination strategy, marketing, and sustainable tourism development." 
  },
  { 
    title: "CBPD Certificate in Travel Agency Operations", 
    desc: "Master travel consultancy, reservation systems, itinerary planning, ticketing, and customer service excellence in travel agencies." 
  },
  { 
    title: "CBPD Certificate in Tour Operations & Guiding", 
    desc: "Learn tour planning, group management, destination knowledge, cultural interpretation, and professional tour guiding techniques." 
  },
  { 
    title: "CBPD Certificate in Destination Management & Marketing", 
    desc: "Gain expertise in promoting destinations, developing tourism products, branding, and digital destination marketing." 
  },
  { 
    title: "CBPD Certificate in Sustainable Tourism Practices", 
    desc: "Explore eco-tourism, responsible travel, community-based tourism, carbon reduction, and sustainable destination development." 
  },
  { 
    title: "CBPD Certificate in Hospitality & Tourism Integration", 
    desc: "Understand the relationship between hospitality services and tourism, including accommodation, food & beverage, and guest experience." 
  },
  { 
    title: "CBPD Certificate in Event & MICE Tourism", 
    desc: "Focus on Meetings, Incentives, Conferences, and Exhibitions (MICE), event planning, and business tourism management." 
  },
  { 
    title: "CBPD Certificate in Airline & Airport Tourism Services", 
    desc: "Learn airport operations, passenger handling, airline customer service, and travel logistics." 
  },
  { 
    title: "CBPD Certificate in Cultural & Heritage Tourism", 
    desc: "Develop skills in managing and promoting cultural sites, heritage attractions, and authentic cultural experiences." 
  },
  { 
    title: "CBPD Certificate in Adventure & Eco-Tourism", 
    desc: "Specialised training in adventure tourism activities, risk management, and environmentally responsible tourism." 
  },
  { 
    title: "CBPD Certificate in Digital Tourism & E-Tourism", 
    desc: "Master online travel platforms, digital marketing, social media strategies, and virtual tourism experiences." 
  },
  { 
    title: "CBPD Certificate in Crisis Management in Tourism", 
    desc: "Prepare for tourism crises, disaster recovery, reputation management, and business continuity in the travel sector." 
  },
  { 
    title: "CBPD Certificate in Tourism Sales & Customer Experience", 
    desc: "Enhance sales techniques, customer journey management, and delivering memorable tourist experiences." 
  },
  { 
    title: "CBPD Certificate in Wildlife & Nature Tourism", 
    desc: "Focus on safari operations, wildlife guiding, conservation tourism, and responsible nature-based travel." 
  },
  { 
    title: "CBPD Certificate in Advanced Tourism Leadership & Strategy", 
    desc: "For experienced professionals — strategic tourism planning, policy development, and industry leadership." 
  }
];

const benefits = [
  "Practical, industry-focused learning with immediate application in travel agencies, tour operations, and destination management",
  "Flexible delivery modes designed for busy tourism professionals",
  "Prestigious UK-issued CBPD certification recognised by employers in the global tourism and travel sector",
  "Strong coverage of modern tourism trends including sustainable tourism, digital strategies, and crisis management",
  "Clear pathways for career progression from operational roles to management and strategic positions"
];

const steps = [
  "Select the CBPD Tourism programme that matches your role and career goals",
...
export default function TourismProgramPage() {
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-primary-900 pb-20">
      ...
      <div className="bg-white dark:bg-primary-900 pt-32 pb-4 border-b border-slate-200 dark:border-primary-800">
        <div className="container mx-auto px-6 md:px-12 flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400 font-medium">
          ...
          <span className="text-slate-300 dark:text-slate-600">/</span>
          <span className="text-slate-900 dark:text-white">Tourism Programmes</span>
        </div>
      </div>
      ...
      <section className="py-20 lg:py-24 relative overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('/images/external/1436491865332-7a61a109cc05.jpg')` }}
        ></div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-8">
              CBPD <span className="text-brand-red">Tourism Programmes</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed font-light">
              Equipping tourism professionals, travel consultants, destination managers, tour operators, and hospitality professionals with immediately applicable skills for the dynamic global tourism industry.
            </p>
      ...
      <section className="bg-brand-blue/5 dark:bg-brand-blue/10 border-b border-slate-200 dark:border-primary-800 py-10">
        <div className="container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <p className="text-lg md:text-xl text-slate-700 dark:text-slate-200 font-medium leading-relaxed">
            The Central Board of Professional Development (CBPD) offers a comprehensive range of practical Tourism programmes designed to equip professionals with immediately applicable skills.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
            ...
            <div className="lg:w-[65%] xl:w-[70%]">
              ...
              <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 mb-12">
                <p>
                  CBPD Tourism certifications focus on <strong>destination management, customer experience, sustainable tourism, tour operations, and digital tourism strategies</strong> — helping professionals deliver exceptional travel experiences while enabling tourism organisations, travel agencies, hotels, and destination boards to boost visitor satisfaction, revenue, and long-term sustainability.
                </p>
                <p>
                  All CBPD Tourism programmes are delivered flexibly through our authorised partners in online, blended, or classroom formats and lead to prestigious UK-issued CBPD certifications recognised by employers in the UK and internationally.
                </p>
              </div>
              ...
              {activeTab === 'overview' && (
                <div className="animate-[fadeInUp_0.5s_ease-out]">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-8">
                    CBPD provides targeted, high-impact programmes across key tourism and travel disciplines.
                  </p>
              ...
              {activeTab === 'why' && (
                <div className="animate-[fadeInUp_0.5s_ease-out] bg-white dark:bg-primary-800 p-8 rounded border border-slate-200 dark:border-primary-700 shadow-sm">
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Why Choose CBPD for Tourism Professional Development?</h2>
                  <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    CBPD delivers shorter, more practical, and flexible tourism credentials compared with many traditional qualifications. 
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                    Our programmes combine essential travel operations with contemporary skills such as sustainable tourism, digital marketing, and destination strategy — helping professionals and organisations thrive in the competitive and recovering global tourism industry.
                  </p>
                </div>
              )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-primary-900 p-10 lg:p-12 rounded-sm relative overflow-hidden flex flex-col justify-center items-start group">
            ...
            <p className="text-slate-300 mb-8 max-w-sm relative z-10">
              Authorised partners have exclusive rights to deliver CBPD tourism programmes globally.
            </p>
