...
const programs = [
  { 
    title: "CBPD Certificate in Mechanical Engineering Practices", 
    desc: "Develop core skills in mechanical design, thermodynamics, materials science, manufacturing processes, and maintenance engineering for industrial applications." 
  },
  { 
    title: "CBPD Certificate in Electrical & Electronic Engineering", 
    desc: "Gain practical knowledge of electrical systems, circuit design, power distribution, electronics, and control systems used in modern engineering environments." 
  },
  { 
    title: "CBPD Certificate in Civil Engineering & Infrastructure", 
    desc: "Master site investigation, structural principles, road and bridge design, geotechnical engineering, and infrastructure project delivery." 
  },
  { 
    title: "CBPD Certificate in Chemical & Process Engineering", 
    desc: "Learn process design, safety in chemical plants, fluid mechanics, heat transfer, and optimisation of industrial chemical processes." 
  },
  { 
    title: "CBPD Certificate in Project Management for Engineers", 
    desc: "Apply engineering-specific project planning, scheduling, risk management, cost control, and stakeholder coordination techniques." 
  },
  { 
    title: "CBPD Certificate in Health & Safety for Engineers", 
    desc: "Focus on engineering-specific risk assessments, hazard identification, compliance with regulations, and creating safe working environments." 
  },
  { 
    title: "CBPD Certificate in Sustainable Engineering & Environmental Management", 
    desc: "Explore green engineering principles, life-cycle assessment, energy-efficient design, and sustainable solutions across engineering disciplines." 
  },
  { 
    title: "CBPD Certificate in Building Information Modelling (BIM) for Engineers", 
    desc: "Develop skills in digital engineering, 3D modelling, collaborative BIM workflows, and clash detection for improved project outcomes." 
  },
  { 
    title: "CBPD Certificate in Quality Assurance & Control in Engineering", 
    desc: "Implement quality management systems, inspection techniques, non-destructive testing, and continuous improvement in engineering projects." 
  },
  { 
    title: "CBPD Certificate in Automation & Control Systems", 
    desc: "Learn industrial automation, PLC programming, SCADA systems, robotics, and smart control technologies." 
  },
  { 
    title: "CBPD Certificate in Structural Engineering Principles", 
    desc: "Understand structural analysis, design of steel and concrete structures, seismic considerations, and load calculations." 
  },
  { 
    title: "CBPD Certificate in Engineering Drawing & CAD", 
    desc: "Enhance technical drawing skills, 2D/3D CAD modelling, and accurate documentation for engineering projects." 
  },
  { 
    title: "CBPD Certificate in Risk Management in Engineering", 
    desc: "Identify, assess, and mitigate technical, operational, financial, and safety risks throughout the engineering project lifecycle." 
  },
  { 
    title: "CBPD Certificate in Emerging Technologies in Engineering", 
    desc: "Explore Industry 4.0, artificial intelligence applications, additive manufacturing (3D printing), and IoT in engineering." 
  },
  { 
    title: "CBPD Certificate in Engineering Leadership & Professional Development", 
    desc: "Build leadership, communication, team management, and ethical decision-making skills tailored for engineering professionals." 
  }
];

const benefits = [
  "Practical, job-focused learning with immediate application on engineering projects and sites.",
  "Flexible delivery modes designed for busy engineering professionals.",
  "Prestigious UK-issued CBPD certification recognised by employers in the UK and globally.",
  "Strong coverage of core engineering disciplines combined with modern topics such as sustainability, BIM, and automation.",
  "Clear pathways for career progression and professional registration support."
];

const steps = [
  "Select the CBPD Engineering programme that matches your engineering discipline and career goals.",
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-primary-900 pb-20">
      ...
      <div className="bg-white dark:bg-primary-900 pt-32 pb-4 border-b border-slate-200 dark:border-primary-800">
        <div className="container mx-auto px-6 md:px-12 flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400 font-medium">
          ...
          <span className="text-slate-300 dark:text-slate-600">/</span>
          <span className="text-slate-900 dark:text-white">Engineering Programmes</span>
        </div>
      </div>
      ...
      <section className="py-20 lg:py-24 relative overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('/images/external/1581092160562-40aa08e78837.jpg')` }}
        ></div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-8">
              CBPD <span className="text-brand-red">Engineering</span> Programmes
            </h1>
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed font-light">
              Equipping mechanical, electrical, civil, chemical, and systems engineering professionals with immediately applicable skills for complex, evolving challenges.
            </p>
      ...
      <section className="bg-brand-blue/5 dark:bg-brand-blue/10 border-b border-slate-200 dark:border-primary-800 py-10">
        <div className="container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <p className="text-lg md:text-xl text-slate-700 dark:text-slate-200 font-medium leading-relaxed">
            The Central Board of Professional Development (CBPD) offers a comprehensive range of practical Engineering programmes designed to help professionals advance their careers and support organisations in delivering safe, future-ready engineering solutions.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
            ...
            <div className="lg:w-[65%] xl:w-[70%]">
              ...
              <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 mb-12">
                <p>
                  CBPD Engineering certifications focus on <strong>real-world project delivery, technical excellence, safety standards, innovation, and sustainable practices</strong>. 
                </p>
                <p>
                  These principles help engineers maintain professional competence while securing safe and efficient operational impacts on broad industrial scapes. All CBPD Engineering programmes are delivered flexibly through our authorised partners in online, blended, or classroom formats and lead to prestigious UK-issued CBPD certifications recognised by employers internationally.
                </p>
              </div>
              ...
              {activeTab === 'overview' && (
                <div className="animate-[fadeInUp_0.5s_ease-out]">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-8">
                    CBPD provides targeted, high-impact programmes across major engineering disciplines. Each programme emphasises practical application, current industry standards, and measurable workplace impact.
                  </p>
              ...
              {activeTab === 'why' && (
                <div className="animate-[fadeInUp_0.5s_ease-out] bg-white dark:bg-primary-800 p-8 rounded border border-slate-200 dark:border-primary-700 shadow-sm">
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Why Choose CBPD for Engineering Professional Development?</h2>
                  <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    CBPD delivers shorter, more practical, and highly flexible engineering credentials compared with many traditional qualifications. 
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                    Our programmes combine strong technical foundations with contemporary skills such as sustainable engineering, digital tools, and leadership—helping engineers and organisations achieve faster competence, innovation, and project success.
                  </p>
                </div>
              )}
            ...
            <div className="lg:w-[35%] xl:w-[30%]">
              <div className="sticky top-28 space-y-6">
                ...
                <div className="bg-primary-900 rounded-sm shadow-lg p-6 lg:p-8 text-center text-white relative overflow-hidden">
                   ...
                   <p className="text-sm text-slate-300 mb-6 relative z-10">Our support team is ready to help you find the right engineering programme.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-primary-900 p-10 lg:p-12 rounded-sm relative overflow-hidden flex flex-col justify-center items-start group">
            ...
            <p className="text-slate-300 mb-8 max-w-sm relative z-10">
              Authorised partners have exclusive rights to deliver CBPD engineering programmes globally.
            </p>
