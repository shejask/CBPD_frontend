...
const programs = [
  { 
    title: "CBPD Certificate in Telecommunications Fundamentals", 
    desc: "Build a strong foundation in telecom principles, signal transmission, network architecture, and industry terminology." 
  },
  { 
    title: "CBPD Certificate in 5G & Next-Generation Networks", 
    desc: "Master 5G technology, network slicing, edge computing, massive MIMO, and the deployment of future mobile networks." 
  },
  { 
    title: "CBPD Certificate in Fibre Optic Technology & Installation", 
    desc: "Learn fibre optic cable installation, splicing, testing, troubleshooting, and maintenance for high-speed broadband networks." 
  },
  { 
    title: "CBPD Certificate in Wireless & Mobile Communications", 
    desc: "Develop skills in radio frequency (RF) engineering, wireless network design, microwave links, and mobile communication systems." 
  },
  { 
    title: "CBPD Certificate in Network Management & Operations", 
    desc: "Gain expertise in network monitoring, fault management, performance optimisation, and telecom operations support systems." 
  },
  { 
    title: "CBPD Certificate in IP Networking & VoIP", 
    desc: "Understand IP networks, Voice over IP (VoIP), SIP protocols, and convergence of voice and data services." 
  },
  { 
    title: "CBPD Certificate in Telecommunications Project Management", 
    desc: "Learn to plan, execute, and manage large-scale telecom infrastructure and rollout projects efficiently." 
  },
  { 
    title: "CBPD Certificate in Customer Service in Telecommunications", 
    desc: "Focus on delivering excellent customer experience, technical support, complaint handling, and service quality management." 
  },
  { 
    title: "CBPD Certificate in Broadband & Internet Services", 
    desc: "Cover fixed broadband technologies, FTTH (Fibre to the Home), xDSL, and high-speed internet service delivery." 
  },
  { 
    title: "CBPD Certificate in Telecom Regulation & Compliance", 
    desc: "Understand regulatory frameworks, licensing, spectrum management, data protection, and industry standards." 
  },
  { 
    title: "CBPD Certificate in Satellite Communication", 
    desc: "Explore satellite technology, VSAT systems, earth station operations, and satellite-based connectivity solutions." 
  },
  { 
    title: "CBPD Certificate in Cybersecurity in Telecommunications", 
    desc: "Learn to protect telecom networks from cyber threats, secure infrastructure, and ensure data privacy." 
  },
  { 
    title: "CBPD Certificate in Telecom Sales & Business Development", 
    desc: "Develop skills in selling telecom solutions, contract negotiation, and building long-term client relationships." 
  },
  { 
    title: "CBPD Certificate in Emerging Technologies in Telecom", 
    desc: "Explore IoT connectivity, AI applications in networks, cloud-based telecom services, and future trends." 
  },
  { 
    title: "CBPD Certificate in Advanced Telecommunications Management", 
    desc: "For experienced professionals — strategic leadership, network planning, digital transformation, and business strategy in telecom." 
  }
];

const benefits = [
  "Practical, industry-focused learning with immediate application in telecom networks and operations",
  "Flexible delivery modes designed for working telecom professionals and technicians",
  "Prestigious UK-issued CBPD certification recognised by employers in the telecommunications sector globally",
  "Strong coverage of modern technologies including 5G, fibre optics, wireless systems, and network management",
  "Clear pathways for career progression in technical, operational, project, and management roles"
];

const steps = [
  "Select the CBPD Telecommunications programme that matches your role and career goals",
...
export default function TelecommunicationsProgramPage() {
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-primary-900 pb-20">
      ...
      <div className="bg-white dark:bg-primary-900 pt-32 pb-4 border-b border-slate-200 dark:border-primary-800">
        <div className="container mx-auto px-6 md:px-12 flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400 font-medium">
          ...
          <span className="text-slate-300 dark:text-slate-600">/</span>
          <span className="text-slate-900 dark:text-white">Telecommunications Programmes</span>
        </div>
      </div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-8">
              CBPD <span className="text-brand-red">Telecommunications Programmes</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed font-light">
              Equipping telecom engineers, network technicians, project managers, customer service professionals, and industry specialists with immediately applicable skills for today's rapidly evolving telecommunications sector.
            </p>
      ...
      <section className="bg-brand-blue/5 dark:bg-brand-blue/10 border-b border-slate-200 dark:border-primary-800 py-10">
        <div className="container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <p className="text-lg md:text-xl text-slate-700 dark:text-slate-200 font-medium leading-relaxed">
            The Central Board of Professional Development (CBPD) offers a comprehensive range of practical Telecommunications programmes designed to equip professionals with immediately applicable skills.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
            ...
            <div className="lg:w-[65%] xl:w-[70%]">
              ...
              <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 mb-12">
                <p>
                  CBPD Telecommunications certifications focus on <strong>network technologies, 5G and next-generation systems, fibre optics, wireless communication, regulatory compliance, and digital infrastructure</strong> — helping professionals stay at the forefront of the industry while enabling telecom companies, service providers, and infrastructure organisations to deliver reliable, high-speed connectivity and excellent customer service.
                </p>
                <p>
                  All CBPD Telecommunications programmes are delivered flexibly through our authorised partners in online, blended, or classroom formats and lead to prestigious UK-issued CBPD certifications recognised by employers in the UK and internationally.
                </p>
              </div>
              ...
              {activeTab === 'overview' && (
                <div className="animate-[fadeInUp_0.5s_ease-out]">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-8">
                    CBPD provides targeted, high-impact programmes across key telecommunications disciplines.
                  </p>
              ...
              {activeTab === 'why' && (
                <div className="animate-[fadeInUp_0.5s_ease-out] bg-white dark:bg-primary-800 p-8 rounded border border-slate-200 dark:border-primary-700 shadow-sm">
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Why Choose CBPD for Telecommunications Professional Development?</h2>
                  <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    CBPD delivers shorter, more practical, and flexible telecommunications credentials compared with many traditional qualifications. 
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                    Our programmes combine core technical knowledge with cutting-edge topics such as 5G, fibre optics, and cybersecurity — helping professionals and organisations succeed in the fast-moving global telecommunications industry.
                  </p>
                </div>
              )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-primary-900 p-10 lg:p-12 rounded-sm relative overflow-hidden flex flex-col justify-center items-start group">
            ...
            <p className="text-slate-300 mb-8 max-w-sm relative z-10">
              Authorised partners have exclusive rights to deliver CBPD telecommunications programmes globally.
            </p>
