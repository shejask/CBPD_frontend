...
const programs = [
  { 
    title: "CBPD Certificate in Maritime Operations & Ship Management", 
    desc: "Master vessel operations, voyage planning, cargo handling, crew management, and day-to-day maritime business practices." 
  },
  { 
    title: "CBPD Certificate in Marine Engineering", 
    desc: "Develop practical skills in marine propulsion systems, auxiliary machinery, maintenance, troubleshooting, and engine room operations." 
  },
  { 
    title: "CBPD Certificate in Port & Harbour Management", 
    desc: "Learn port operations, terminal management, cargo logistics, berth allocation, and efficient port administration." 
  },
  { 
    title: "CBPD Certificate in Maritime Safety & Survival at Sea", 
    desc: "Focus on personal survival techniques, life-saving appliances, search and rescue, and emergency procedures at sea." 
  },
  { 
    title: "CBPD Certificate in International Maritime Regulations & Compliance", 
    desc: "Understand key conventions including SOLAS, MARPOL, STCW, ISM Code, and flag state/port state control requirements." 
  },
  { 
    title: "CBPD Certificate in Marine Health & Safety Management", 
    desc: "Implement effective health and safety systems on board vessels and in marine workplaces, including risk assessment and incident prevention." 
  },
  { 
    title: "CBPD Certificate in Maritime Logistics & Supply Chain Management", 
    desc: "Explore global shipping logistics, freight forwarding, multimodal transport, and international supply chain optimisation." 
  },
  { 
    title: "CBPD Certificate in Ship Stability & Cargo Operations", 
    desc: "Gain expertise in ship stability calculations, cargo stowage, securing, and safe loading/unloading procedures." 
  },
  { 
    title: "CBPD Certificate in Oil & Chemical Tanker Operations", 
    desc: "Specialised training in tanker safety, cargo handling, tank cleaning, and pollution prevention for liquid bulk carriers." 
  },
  { 
    title: "CBPD Certificate in Maritime Environmental Management", 
    desc: "Learn pollution prevention, ballast water management, emissions control, and sustainable maritime practices." 
  },
  { 
    title: "CBPD Certificate in Yacht & Small Craft Operations", 
    desc: "Practical skills for operating and managing private yachts, superyachts, and small commercial vessels." 
  },
  { 
    title: "CBPD Certificate in Bridge Resource Management (BRM)", 
    desc: "Develop team leadership, situational awareness, communication, and decision-making skills for bridge teams." 
  },
  { 
    title: "CBPD Certificate in Engine Resource Management (ERM)", 
    desc: "Focus on effective engine room team management, resource optimisation, and safety in machinery spaces." 
  },
  { 
    title: "CBPD Certificate in Maritime Security & Piracy Awareness", 
    desc: "Understand ISPS Code, ship security plans, threat assessment, and piracy prevention measures." 
  },
  { 
    title: "CBPD Certificate in Advanced Maritime Leadership", 
    desc: "For experienced professionals — strategic leadership, crisis management, and organisational development in the marine sector." 
  }
];

const benefits = [
  "Practical, industry-specific learning with immediate application on vessels and in port environments.",
  "Flexible delivery modes designed for seafarers and shore-based marine professionals.",
  "Prestigious UK-issued CBPD certification recognised by employers in the global maritime industry.",
  "Strong alignment with international maritime conventions (STCW, SOLAS, MARPOL, ISM) and best practices.",
  "Clear pathways for career progression from operational roles to management and leadership positions."
];

const steps = [
  "Select the CBPD Marine programme that matches your role and career goals.",
...
export default function MarineProgramPage() {
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-primary-900 pb-20">
      ...
      <div className="bg-white dark:bg-primary-900 pt-32 pb-4 border-b border-slate-200 dark:border-primary-800">
        <div className="container mx-auto px-6 md:px-12 flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400 font-medium">
          ...
          <span className="text-slate-300 dark:text-slate-600">/</span>
          <span className="text-slate-900 dark:text-white">Marine Programmes</span>
        </div>
      </div>
      ...
      <section className="py-20 lg:py-24 relative overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1494607239400-f1396a5d7cbf?q=80&w=1600&auto=format&fit=crop')` }}
        ></div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-8">
              CBPD <span className="text-brand-red">Marine Programmes</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed font-light">
              Equipping maritime professionals, seafarers, marine engineers, and logistics specialists with immediately applicable skills for the global maritime industry.
            </p>
      ...
      <section className="bg-brand-blue/5 dark:bg-brand-blue/10 border-b border-slate-200 dark:border-primary-800 py-10">
        <div className="container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <p className="text-lg md:text-xl text-slate-700 dark:text-slate-200 font-medium leading-relaxed">
            The Central Board of Professional Development (CBPD) offers a comprehensive range of practical Marine programmes designed to equip maritime professionals with immediately applicable skills for the global maritime industry.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
            ...
            <div className="lg:w-[65%] xl:w-[70%]">
              ...
              <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 mb-12">
                <p>
                  CBPD Marine certifications focus on <strong>safety at sea, vessel operations, marine engineering, port management, maritime logistics, and regulatory compliance</strong>. 
                </p>
                <p>
                  This focus helps professionals enhance their competence while enabling shipping companies, ports, and marine organisations to maintain high standards of safety, efficiency, and environmental responsibility. All CBPD Marine programmes are delivered flexibly through our authorised partners in online, blended, or classroom formats and lead to prestigious UK-issued CBPD certifications globally recognised by employers.
                </p>
              </div>
              ...
              {activeTab === 'overview' && (
                <div className="animate-[fadeInUp_0.5s_ease-out]">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-8">
                    CBPD provides targeted, high-impact programmes across key marine and maritime disciplines to equip your team with sector-leading expertise.
                  </p>
              ...
              {activeTab === 'why' && (
                <div className="animate-[fadeInUp_0.5s_ease-out] bg-white dark:bg-primary-800 p-8 rounded border border-slate-200 dark:border-primary-700 shadow-sm">
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Why Choose CBPD for Marine Professional Development?</h2>
                  <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    CBPD delivers shorter, more practical, and highly flexible marine credentials when compared with many traditional qualifications. 
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                    Our programmes seamlessly combine essential maritime safety and operational skills with modern topics such as environmental management and digital logistics—helping professionals and organisations achieve higher standards of safety, efficiency, and compliance in the global marine industry.
                  </p>
                </div>
              )}
            ...
            <div className="lg:w-[35%] xl:w-[30%]">
              <div className="sticky top-28 space-y-6">
                ...
                <div className="bg-primary-900 rounded-sm shadow-lg p-6 lg:p-8 text-center text-white relative overflow-hidden">
                   ...
                   <p className="text-sm text-slate-300 mb-6 relative z-10">Our support team is ready to help you find the right marine programme.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-primary-900 p-10 lg:p-12 rounded-sm relative overflow-hidden flex flex-col justify-center items-start group">
            ...
            <p className="text-slate-300 mb-8 max-w-sm relative z-10">
              Authorised partners have exclusive rights to deliver CBPD marine programmes globally.
            </p>
