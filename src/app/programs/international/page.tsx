...
const programs = [
  { 
    title: "CBPD Certificate in International Business Management", 
    desc: "Develop skills in global strategy, international market entry, cross-border operations, and managing multinational teams." 
  },
  { 
    title: "CBPD Certificate in Cross-Cultural Management & Communication", 
    desc: "Master cultural intelligence, effective communication across cultures, negotiation in diverse environments, and building global relationships." 
  },
  { 
    title: "CBPD Certificate in International Trade & Global Commerce", 
    desc: "Gain practical knowledge of international trade regulations, export-import procedures, trade finance, and global supply chain management." 
  },
  { 
    title: "CBPD Certificate in Global Leadership & International Relations", 
    desc: "Build leadership capabilities for international roles, diplomatic awareness, and managing geopolitical influences in business." 
  },
  { 
    title: "CBPD Certificate in International Marketing & Brand Management", 
    desc: "Learn strategies for marketing products and services across different countries, cultural adaptation, and building global brands." 
  },
  { 
    title: "CBPD Certificate in International Human Resource Management", 
    desc: "Focus on global talent acquisition, expatriate management, international employment law, and multicultural team development." 
  },
  { 
    title: "CBPD Certificate in Diplomacy & International Negotiation", 
    desc: "Develop advanced negotiation skills, diplomatic protocols, conflict resolution, and international dispute settlement techniques." 
  },
  { 
    title: "CBPD Certificate in Global Supply Chain & Logistics Management", 
    desc: "Master international logistics, customs procedures, risk management in global supply chains, and sustainable international distribution." 
  },
  { 
    title: "CBPD Certificate in International Finance & Risk Management", 
    desc: "Explore foreign exchange markets, international investment, currency risk, and financial management in a global context." 
  },
  { 
    title: "CBPD Certificate in Sustainable Development & International Development", 
    desc: "Understand global sustainability goals, international development projects, aid management, and ESG practices in global operations." 
  },
  { 
    title: "CBPD Certificate in International Project Management", 
    desc: "Apply project management principles to cross-border projects, multicultural stakeholder management, and global project delivery." 
  },
  { 
    title: "CBPD Certificate in Immigration & Global Mobility", 
    desc: "Learn immigration policies, work visas, expatriate relocation, and compliance with international mobility regulations." 
  },
  { 
    title: "CBPD Certificate in Geopolitics & International Business Risk", 
    desc: "Analyse geopolitical trends, country risk assessment, and strategies to mitigate political and economic risks in international business." 
  },
  { 
    title: "CBPD Certificate in International Business Law & Compliance", 
    desc: "Cover international contracts, trade agreements, regulatory compliance, and legal frameworks for global operations." 
  },
  { 
    title: "CBPD Certificate in Advanced Global Strategy & Emerging Markets", 
    desc: "For experienced professionals — strategic planning for entering and succeeding in emerging and developed international markets." 
  }
];

const benefits = [
  "Practical, globally-oriented learning with immediate application in international roles and organisations.",
  "Flexible delivery modes designed for professionals working across borders.",
  "Prestigious UK-issued CBPD certification recognised by employers worldwide.",
  "Strong focus on cross-cultural competence, international trade, and global leadership skills.",
  "Clear pathways for career progression in multinational companies, trade organisations, and international institutions."
];

const steps = [
  "Select the CBPD International programme that matches your global role and career goals.",
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-primary-900 pb-20">
      ...
      <div className="bg-white dark:bg-primary-900 pt-32 pb-4 border-b border-slate-200 dark:border-primary-800">
        <div className="container mx-auto px-6 md:px-12 flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400 font-medium">
          ...
          <span className="text-slate-300 dark:text-slate-600">/</span>
          <span className="text-slate-900 dark:text-white">International Programmes</span>
        </div>
      </div>
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-8">
              CBPD <span className="text-brand-red">International Programmes</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 mb-10 leading-relaxed font-light">
              Equipping professionals working in global business, international trade, diplomacy, and multinational operations with immediately applicable cross-cultural skills.
            </p>
      ...
      <section className="bg-brand-blue/5 dark:bg-brand-blue/10 border-b border-slate-200 dark:border-primary-800 py-10">
        <div className="container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <p className="text-lg md:text-xl text-slate-700 dark:text-slate-200 font-medium leading-relaxed">
            The Central Board of Professional Development (CBPD) offers a comprehensive range of practical International programmes designed to equip professionals with immediately applicable skills for today's interconnected world.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
            ...
            <div className="lg:w-[65%] xl:w-[70%]">
              ...
              <div className="prose prose-lg prose-slate dark:prose-invert max-w-none text-slate-600 dark:text-slate-300 mb-12">
                <p>
                  CBPD International certifications focus on <strong>global business strategy, cross-cultural competence, international regulations, trade practices, and managing operations across borders</strong>. 
                </p>
                <p>
                  This focus helps professionals navigate international environments successfully while enabling organisations to expand globally with confidence and cultural intelligence. All CBPD International programmes are delivered flexibly through our authorised partners in online, blended, or classroom formats and lead to prestigious UK-issued CBPD certifications globally recognised by employers.
                </p>
              </div>
              ...
              {activeTab === 'overview' && (
                <div className="animate-[fadeInUp_0.5s_ease-out]">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-8">
                    CBPD provides targeted, high-impact programmes across key international and global disciplines to equip you for success across borders.
                  </p>
              ...
              {activeTab === 'why' && (
                <div className="animate-[fadeInUp_0.5s_ease-out] bg-white dark:bg-primary-800 p-8 rounded border border-slate-200 dark:border-primary-700 shadow-sm">
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">Why Choose CBPD for International Professional Development?</h2>
                  <p className="text-slate-600 dark:text-slate-300 mb-6 leading-relaxed text-lg">
                    CBPD delivers shorter, more practical, and highly flexible international credentials when compared with many traditional, rigid qualifications. 
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                    Our targeted programmes seamlessly combine global business knowledge with essential cross-cultural and strategic skills. This ensures professionals and organisations have the tools needed to navigate challenges and succeed in today's complex international marketplace.
                  </p>
                </div>
              )}
            ...
            <div className="lg:w-[35%] xl:w-[30%]">
              <div className="sticky top-28 space-y-6">
                ...
                <div className="bg-primary-900 rounded-sm shadow-lg p-6 lg:p-8 text-center text-white relative overflow-hidden">
                   ...
                   <p className="text-sm text-slate-300 mb-6 relative z-10">Our support team is ready to help you find the right international programme.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-primary-900 p-10 lg:p-12 rounded-sm relative overflow-hidden flex flex-col justify-center items-start group">
            ...
            <p className="text-slate-300 mb-8 max-w-sm relative z-10">
              Authorised partners have exclusive rights to deliver CBPD international programmes globally.
            </p>
