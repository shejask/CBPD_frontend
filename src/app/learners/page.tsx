...
export default function LearnersPage() {
  ...
  const testimonials = [
    { name: "Hanoona Fathima", role: "India", quote: "The Diploma in Hospital Administration from CBPD helped me understand hospital operations, patient management, healthcare coordination, and medical office systems in a professional way. The course content was practical and industry-focused, which improved my confidence for working in the healthcare sector.", image: "/images/testimonials/hanoona-fathima.jpeg" },
    { name: "Abhinanda", role: "India", quote: "CBPD’s Diploma in Hospital Administration provided excellent knowledge in healthcare management, administration procedures, communication skills, and hospital documentation systems. The programme structure was clear and easy to follow, and it gave me valuable insights into modern hospital operations.", image: "/images/testimonials/abhinanda.jpeg" },
    { name: "Gopika", role: "India", quote: "I was searching for a professional qualification in hospital administration, and CBPD exceeded my expectations. The diploma covered healthcare ethics, patient care coordination, hospital management, and administrative responsibilities in detail. This programme added strong value to my professional profile.", image: "/images/testimonials/gopika.jpeg" },
    { name: "Amitha", role: "India", quote: "The Diploma in Hospital Administration offered by CBPD was highly informative and professionally designed. The learning experience helped me develop leadership, communication, and healthcare administration skills that are essential in today’s medical industry.", image: "/images/testimonials/amitha.jpeg" },
    { name: "Sarah Jenkins", role: "UK", quote: "Securing my Diploma in Project Management through CBPD was a phenomenal milestone in my career. The entire process was incredibly streamlined, and the instant global recognition helped me land my current senior role within two months.", image: "/images/testimonials/sarah-jenkins.jpg" },
    { name: "David Chen", role: "Singapore", quote: "The rigour of the Certificate in Data Analytics proved the high quality of the CBPD accreditation. My employer immediately recognized the value of the credential. Highly recommend this for professionals looking to upskill quickly but reliably.", image: "/images/testimonials/david-chen.jpg" },
    { name: "Elena Rodriguez", role: "Spain", quote: "The Advanced Diploma in Human Resources was exactly what I needed. As an HR professional, I look for candidates with verified, practical skills. CBPD's approach to professional mastery and real-world application means a candidate holding this certification is ready to hit the ground running.", image: "/images/testimonials/elena-rodriguez.jpg" },
    { name: "Michael Chang", role: "Canada", quote: "I was looking for a Diploma in Operations Management that carried weight across North America and Europe. CBPD exceeded my expectations. The structured curriculum and networking opportunities with other industry experts have been incredibly valuable.", image: "/images/testimonials/michael-chang.jpg" },
  ];
