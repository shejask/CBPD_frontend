...
export default function LearnersPage() {
  ...
  const testimonials = [
    ...
    { name: "Sarah Jenkins", role: "UK", quote: "Securing my Diploma in Project Management through CBPD was a phenomenal milestone in my career. The entire process was incredibly streamlined, and the instant global recognition helped me land my current senior role within two months.", image: "/images/external/1494790108377-be9c29b29330.jpg" },
    { name: "David Chen", role: "Singapore", quote: "The rigour of the Certificate in Data Analytics proved the high quality of the CBPD accreditation. My employer immediately recognized the value of the credential. Highly recommend this for professionals looking to upskill quickly but reliably.", image: "/images/external/1507003211169-0a1dd7228f2d.jpg" },
    { name: "Elena Rodriguez", role: "Spain", quote: "The Advanced Diploma in Human Resources was exactly what I needed. As an HR professional, I look for candidates with verified, practical skills. CBPD's approach to professional mastery and real-world application means a candidate holding this certification is ready to hit the ground running.", image: "/images/external/1573496359142-b8d87734a5a2.jpg" },
    { name: "Michael Chang", role: "Canada", quote: "I was looking for a Diploma in Operations Management that carried weight across North America and Europe. CBPD exceeded my expectations. The structured curriculum and networking opportunities with other industry experts have been incredibly valuable.", image: "/images/external/1506794778202-cad84cf45f1d.jpg" },
  ];
