                    ...
                    <div className="row">
                        <div className="col col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="widget subscribe">
                                  <div className="logo">
                                    <Link className='logo' onClick={ClickHandler} href="/"><Image src={logo3} alt="logo" /></Link>
                                </div>
                        ...
                        <div className="col col-xl-2 offset-xl-2 col-lg-2 col-md-6 col-sm-12 col-12">
                            <div className="widget link-widget">
                                ...
                                <ul>
                                    ...
                                    <li><Link onClick={ClickHandler} href="/partner">Partner</Link></li>
                        ...
                        <div className="col col-xl-2 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="widget link-widget">
                                ...
                                <div className="contact-ft">
                                    <ul>
                                        {/* <li>Company -</li> */}
                                        <li>Central Board of professional development 37th Floor 1 Canada Square London, E14 5DY</li>
                    ...
                    <div className="row align-items-center">
                         ...
                         <div className="col col-lg-4 col-12"  >
                            <div className="lower-footer-link">
                                <p className="copyright"> Copyright &copy; 2025 <Link onClick={ClickHandler} href="/home">CBPD.</Link> All rights  reserved.</p>
                            </div>                       
                        </div>
                        ...
                        <div className="col col-lg-8 col-12">
                            <ul className="copy-right"  >
                                <li> <Image src={paymentsicons} alt="payments" width={200} height={40} style={{ width: 'auto', height: 'auto', maxWidth: '300px' }} /> </li>
                             </ul>
                        </div>
